      ...
      {tiers.map((t, idx) => (
        ...
        >
          <div className="w-full flex flex-col items-center gap-2">
            <div className={`w-full h-16 md:h-24 2xl:h-36 ${user?.subscription_tier === t.price.toString() ? "bg-indigo-500" : "bg-lime-400"} rounded-2xl flex items-center justify-center mb-2`}>
              <span className="text-neutral-900 text-3xl sm:text-5xl md:text-7xl 2xl:text-[8rem] font-black">{`$${t.price}`}</span>
            </div>
...
const SubscriptionSection = ({
  ...
  <div className="flex flex-col justify-center gap-1 w-full mt-1 2xl:gap-4 2xl:mt-4">
    <div className="bg-lime-400 rounded-md w-full flex flex-row items-start px-12 py-6 gap-1 2xl:px-32 2xl:py-16 2xl:gap-4 ">
      ...
      <div className="bg-neutral-800 rounded-md w-[18vw] h-[10vh] flex flex-row items-center justify-around px-10 py-6 gap-1 2xl:w-[12vw] 2xl:h-[14vh] 2xl:px-20 2xl:py-12 2xl:gap-4 ">
