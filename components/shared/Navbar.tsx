  ...
  return (
    <nav className="w-full flex flex-row justify-center items-center bg-zinc-900 px-1 sm:px-2 md:px-3 lg:px-4 xl:px-5 pt-2 sm:pt-3 md:pt-2 gap-x-1">
      <div className="flex flex-row items-center gap-1 w-full">
        ...
        {/* Position */}
        {isConnected && (
          <div className={`bg-white rounded-md px-3 sm:px-4 md:px-7 py-0 w-full sm:w-2/5 md:w-2/5 h-[10vh] md:h-[15vh] 2xl:h-[12vh] flex items-center justify-center transition-all duration-300 ${pathname === "/app" ? "border-2 border-pink-400" : ""}`}>
            <Link href="/app">
              <span className="flex flex-col items-center">
        ...
        {/* Profile */}
        {isConnected && (
          <div className={`bg-white rounded-md px-3 sm:px-4 md:px-7 py-0 w-full sm:w-2/5 md:w-2/5 h-[10vh] md:h-[15vh] 2xl:h-[12vh] flex items-center justify-center transition-all duration-300 ${pathname === "/profile" ? "border-2 border-pink-400" : ""}`}>
            <Link href="/profile">
              <span className="flex flex-col items-center">
                <span className="text-neutral-900 ttext-md md:text-2xl 2xl:text-4xl font-semibold hover:text-[#6F52FF] transition-all duration-300">
                  Profile
